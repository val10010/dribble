function SplitText(s, e) {
    ...
    function n(s, e) {
        ...
        for (var n = s.querySelectorAll("div"), l = 0; l < n.length; l++) {
            if (void 0 !== e.vars.wordsClass && "undefined" != e.vars.wordsClass && o(n[l], e.vars.wordsClass.replaceAll("++", l + 1)), null !== e.vars.position) if ("absolute" == e.vars.position) n[l].toBe = {
                top: n[l].offsetTop,
                left: n[l].offsetLeft
            }, n[l].style.position = "relative"; else if ("fixed" == e.vars.position) {
                var a = r(n[l]);
    ...
    function l(s, e) {
        ...
        for (var l = s.querySelectorAll("div"), a = 0; a < l.length; a++) {
            ...
            if (null !== e.vars.position) if ("absolute" == e.vars.position) l[a].toBe = {
                top: l[a].offsetTop,
                left: l[a].offsetLeft
            }, l[a].style.position = "relative"; else if ("fixed" == e.vars.position) {
                var f = r(l[a]);
    ...
    for (var h = 0; h < this.HTMLobjects.length; h++) {
        ...
        if (-1 != this.vars.type.indexOf("lines")) {
            ...
            for (var f = 0; f < w.length; f++) {
                var L = 0 == f ? 0 : w[f - 1] + 1, H = f == w.length - 1 ? g.length : w[f],
                    M = document.createElement("div");
                if (M.style.display = "block", void 0 !== this.vars.linesClass && "undefined" != this.vars.linesClass && (this["class"] = this.vars.linesClass.replace("++", f + 1)), M.innerHTML = g.substring(L, H), d.appendChild(M), null !== this.vars.position) if ("absolute" == this.vars.position) M.toBe = {
                    top: M.offsetTop,
                    left: M.offsetLeft
                }, M.style.position = "relative"; else if ("fixed" == this.vars.position) {
                    var C = r(M);
        ...
        if (-1 != this.vars.type.indexOf("words")) if (-1 != this.vars.type.indexOf("lines")) for (var f = 0; f < y.lines.length; f++) n(y.lines[f], this); else n(d, this);
        if (-1 != this.vars.type.indexOf("chars")) if (-1 != this.vars.type.indexOf("words")) for (var f = 0; f < y.words.length; f++) l(y.words[f], this); else if (-1 != this.vars.type.indexOf("lines")) for (var f = 0; f < y.lines.length; f++) l(y.lines[f], this); else l(d, this);
